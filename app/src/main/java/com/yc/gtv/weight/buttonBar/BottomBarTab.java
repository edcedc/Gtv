package com.yc.gtv.weight.buttonBar;
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_gray));
    ...
    public void setSelected(boolean selected) {
        ...
        switch (mTabPosition){
            case 0:
                mIcon.setImageResource(selected? R.mipmap.tab_home_sel : R.mipmap.tab_home_nor);
                break;
            case 1:
                mIcon.setImageResource(selected? R.mipmap.tab_pd_sel : R.mipmap.tab_pd_nor);
                break;
            case 2:
                mIcon.setImageResource(selected? R.mipmap.tab_tk_sel : R.mipmap.tab_tk_nor);
                break;
            case 3:
                mIcon.setImageResource(selected? R.mipmap.tab_my_sel : R.mipmap.tab_my_nor);
                break;
        }
        if (selected) {
